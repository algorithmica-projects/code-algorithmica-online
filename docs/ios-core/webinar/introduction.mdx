...
To join the stage in a webinar, specific permissions are required, which are managed through [Presets](/guides/basics/basics1). To determine if you have the necessary permissions, use the following command:
